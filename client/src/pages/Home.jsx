...
const Home = () => {
  ...
  //       method: "POST",
  //     });
  //     console.log(res?.data); // This will print the response in the browser console
  //     setSuggestedFriends(res?.data); // Saving the response in state
  //   } catch (error) {
  //     console.log(error); // If something goes wrong, log the error
  //   }
  // };
